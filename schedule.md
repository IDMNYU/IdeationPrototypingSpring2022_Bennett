...
<td valign="top">
      <ul>
         ...
         <li> Write a post regarding the exercises in class for the Future Project, including the writing prompt for your identity.</li>
        ...
        <li> Finish Reading - Show Your Work. Post your <a href = "reflect.md">reflections </a> to your Process site. </li>
        <li><a href ="Time_Management_System.md">Time Management System</a></li>
        <li><a href="constant_input_output.md">constant input/output</a></li>
        </ul>
    </td>
...
<tr>
    ...
    <td valign="top">
    <li><a href = "Future_weeklyBrief.md"> Future Project Homework</a></li>
    <li> Read the latest letters (Slack Resources) from the last co-hort and write a thoughtful reflection on your Process site. How do these letters, your midterm assessment, and feedback inform and/or change your process in this course?</li>
   <li><a href="constant_input_output.md">constant input/output</a></li>
...
<tr>
    ...
    <td valign="top">Review Homework<br> Object Game <br> Future Presentation Brainstorm <p> </td>
    <td valign="top"> <li><a href = "Future_weeklyBrief.md"> Future Project Homework</a></li>
...
<tr>
    ...
    <td valign="top">Constant Input/Output Presentations <p> Future Presentation Dry Run</td>  
    <td valign="top"> 
       <li><a href = "Future_weeklyBrief.md"> Future Project Homework</a></li>
...
<tr>
    ...
    <td valign="top">Review Homework <p> Future Presentation Dry Run <p> Final Future Presentations</td>  
    <td valign="top"> 
   <li><a href = "Future_weeklyBrief.md"> Future Project Homework</a></li>
...
<tr>
    ...
    <td valign="top"> 
     <li>Submit the <a href = "end-of-semester-deliverables.md">End of Semester Deliverables</a> by NOON on May 11th. This work is graded. Late work will not be accepted. </li> 
    </td>
</tr>
</table>
