...
#### [Slack workspace](https://ideationproto-sg44370.slack.com/) The URL is: https://ideationproto-sg44370.slack.com/. You must first have an account with Slack. Once you've signed up with Slack, you may join our workspace using the following link (only good for 30 days): 

[**Link to join Slack**](https://join.slack.com/t/ideationproto-sg44370/shared_invite/zt-124zpnynk-HI2zfJEQikOgh1VKCTRmOQ)
...
* If you are remote for the first 2 weeks of the semester, you must attend class synchronously via Zoom (link is in BrightSpace). If for whatever reason (ie, extreme illness), you cannot attend class synchronously, you must watch the recording (found in BrightSpace) within 48 hours. You are responsible for that material and those assignments discussed during class. If you have questions about the content discussed in that recording, you must submit your questions to Professor Bennett via a Slack Direct Message. These questions must be submitted with 72-96 hours of the orginal class session. Do not let your questions linger to the point of obstructing your ability to complete the assignments on time. It's your responsibility to communicate with the instructor.
...
* If you are dealing with continuing issues as a result of COVID, please communicate with me, so that I can work with you and to support you. If I'm not aware of issues outside of the classroom, my expectations will remain the same, whether you are synchronous or asynchronous. As a result, it's your responsibility to communicate with me.
...
* If you are asynchronous for more than 5 class sesssion, _you must schedule 4 meetings with me during my office hours._ It is up to you to schedule these. If you cannot meet during my office hours, it is up to you to communicate that to me and to suggest an alternative time.
...
* If you have some extenuating need to be outside of class (special doctor's appointment, religious observations, medical issues, COVID issues, etc etc), please contact the Coordinator of Student Advocacy and Compliance at (eng.studentadvocate@nyu.edu, 646.997.3046). A note that office will excuse absences. 
